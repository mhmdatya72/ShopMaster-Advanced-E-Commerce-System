...
<div class="min-h-screen flex">
    <!-- Left side - Image -->
    <div
        class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center text-white p-12">
            <div class="text-center mb-8">
                ...
                <h1 class="text-4xl font-bold mb-4">Welcome to ShopMaster</h1>
                <p class="text-xl text-blue-100">Shop with ease and security with the best products</p>
            </div>
            <div class="grid grid-cols-3 gap-8 text-center">
                <div class="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
                    <div class="text-2xl font-bold">1000+</div>
                    <div class="text-sm text-blue-100">Products</div>
                </div>
                <div class="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                <div
                    class="mx-auto h-16 w-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center mb-4">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                Please sign in to add the product to your cart. You'll be redirected to the product page after successful login.
                            </p>
                        </div>
                    </div>
                </div>
