...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <!-- Total Orders -->
            <div class="admin-hover bg-white overflow-hidden shadow-2xl rounded-2xl border border-gray-100">
                <div class="p-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="mr-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-bold text-gray-900">${{ number_format($stats['total_revenue'],
                                    2) }}</dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="admin-hover bg-white overflow-hidden shadow-2xl rounded-2xl border border-gray-100">
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="h-12 w-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center">
                                <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="mr-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-bold text-gray-900">{{ $stats['total_customers'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <!-- Recent Orders -->
        <div class="mt-8">
            <div class="bg-white admin-hover shadow-2xl rounded-2xl border border-gray-100">
                <div class="px-6 py-6">
                    <h3 class="text-xl font-semibold text-gray-900 mb-6">Recent Orders</h3>
                    ...
                    <div class="text-center py-12">
                        <div
                            class="mx-auto h-16 w-16 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center mb-4">
                            <svg class="h-8 w-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                        </div>
                        <p class="text-lg text-gray-500">No recent orders</p>
                    </div>
                    @endif
                </div>
            </div>
