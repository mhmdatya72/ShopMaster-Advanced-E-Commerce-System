...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Edit Shipping Method: {{ $shippingMethod->name }}</h1>
        ...
        <form action="{{ route('admin.shipping-methods.update', $shippingMethod) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $shippingMethod->name) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                        ...
                        placeholder="Enter shipping method description">{{ old('description', $shippingMethod->description) }}</textarea>
                    @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="cost" name="cost" value="{{ old('cost', $shippingMethod->cost) }}"
                            step="0.01" min="0"
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $shippingMethod->orders_count ?? 0 }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Created At</p>
                                <p class="text-lg font-medium text-gray-900">{{ $shippingMethod->created_at->format('M
                                    d, Y') }}</p>
                            </div>
                        </div>
                    </div>
