...
return [
    ...
    */
    ...
    | A token invalidated if any of these claims are not present in the payload.
    |
    */
    ...
    */
    ...
    | Meaning that if you have a clock skew on your servers then you
    | can set a leeway to account for that.
    |
